# 2.5.1 Работа с функциями: functool и лямбда функции
# когда нужно создавать много однотипных лямбда функций, еще удобнее будет создать функцию,
...
# Пример использования:  mod_3 = mod_checker(3)
# print(mod_3(3)) # True
# print(mod_3(4)) # False

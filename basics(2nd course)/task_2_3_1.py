# task 2.3.1 Итераторы и генераторы
...
# элементам x из последовательности a, что f(x) равно True. Будем говорить, что в этом случае функция
# f допускает элемент x, а элемент x является допущенным.

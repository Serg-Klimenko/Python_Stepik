...
# Требуется написать программу, осуществляющую преобразование из одних единиц измерения длины
# в другие.
...
units = {
    'mile': 1609, 'yard': 0.9144, 'foot': 0.3048, 'inch': 0.0254,
    'km': 1000, 'm': 1, 'cm': 0.01, 'mm': 0.001
    }
input_data = input().split()
print(f'{float(input_data[0]) * units[input_data[1]] / units[input_data[3]]:.2e}')
